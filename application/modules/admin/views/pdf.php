...
<body>
            ...
            <tr>
                <td>
                    <div id="project" class="clearfix">
                        ...
                        <div><a
                                href="mailto:<?php echo get_settings('store_email'); ?>"><?php echo get_settings('store_email'); ?></a>
                        </div>
                    </div>
                </td>
    ...
    <footer>
        Invoice ini dicetak pada <?php echo get_formatted_date(date('Y-m-d H:i:s')); ?> <?php echo date('H:i'); ?> dan
        merupakan bukti transaksi yang sah.
    </footer>
</body>
